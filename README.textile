...
on Linux:
* install all necessary libraries (-> Credits; a2elight is not required/used, CUDA is optional)
...
* build/install all necessary libraries (-> Credits; a2elight is not required/used, CUDA is optional)
