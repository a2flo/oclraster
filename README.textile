...
** alternatively, or if you have an AMD GPU (not recommended CPU devices due to performance issues): install the AMD APP SDK ("AMD APP SDK":http://developer.amd.com/tools/heterogeneous-computing/amd-accelerated-parallel-processing-app-sdk/downloads/#one)
