...
#ifndef __OCLRASTER_VECTOR_4_H__
#define __OCLRASTER_VECTOR_4_H__
...
public:
	...
	oclr_constexpr vector4(const vector3<T>& vec3) noexcept : vector3<T>(vec3.x, vec3.y, vec3.z), w((T)0) {}
