...
#ifndef __OCLRASTER_MATRIX4_H__
#define __OCLRASTER_MATRIX4_H__
...
public:
	...
	oclr_constexpr matrix4() noexcept :
	data({{
		(T)1, (T)0, (T)0, (T)0,
		(T)0, (T)1, (T)0, (T)0,
		(T)0, (T)0, (T)1, (T)0,
		(T)0, (T)0, (T)0, (T)1}}) {}
	oclr_constexpr matrix4(const T& val) noexcept :
	data({{
		val, val, val, val,
		val, val, val, val,
		val, val, val, val,
		val, val, val, val}}) {}
	oclr_constexpr matrix4(matrix4&& m4) noexcept : data(m4.data) {}
	...
	template <typename U> oclr_constexpr matrix4(const matrix4<U>& mat4) noexcept :
	data({{
